...
import { Package, ShoppingBag, Star, MessageSquare, Settings, LogOut, Bell, BellOff, FileText } from 'lucide-react';
...
const TABS = [
    ...
    { id: 'content',  label: 'Contenu',   icon: FileText,      path: '/admin/content',  countKey: null },
