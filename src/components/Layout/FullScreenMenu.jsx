                        ...
                        {navLinks.map((link, idx) => (
                            ...
                            >
                                <div className="flex items-baseline space-x-4">
                                    ...
                                    <span className="font-editorial text-5xl tracking-tighter transition-transform duration-500 group-hover:translate-x-4 group-hover:text-primary md:text-7xl lg:text-8xl">
                                        {link.name}
                                    </span>
                                </div>
                            </Link>
